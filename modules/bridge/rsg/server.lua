...
-- taken from qbox-core (https://github.com/Qbox-project/rsg-core/blob/f4174f311aae8157181a48fa2e2bd30c8d13edb1/client/functions.lua#L25)
...
local function exportHandler(exportName, func)
    AddEventHandler(('__cfx_export_rsg-inventory_%s'):format(exportName), function(setCB)
        setCB(func)
    end)
end
